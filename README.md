...
![Employee Attrition Dashboard](https://github.com/SarkarMita/Employee-Attrition-Analysis/blob/main/Employee%20Attrition%20Dashboard%20.png)
...
## **Process**
1. **Data Preparation in Excel:** Cleaned up the raw employee data in Excel to make sure all categories (like department and age) were consistent.
2. **Metric Calculations:** Created formulas to calculate the 13.84% Attrition Rate and total departures.
3. **Categorization:** Grouped employees into "Salary Slabs" and "Age Brackets" to find patterns in who is leaving.
4. **Dashboard Design:** Built the layout using a dark theme and high-contrast colors to highlight the most important findings.
...
* **Insight 2:** The company is losing its younger talent quickly, with the highest number of exits (**67**) coming from the **26-35 age group**.
...
* **Recommendation 2:** Start a **"Stay Interview" program** for Lab Technicians and Scientists to fix their low job satisfaction before they decide to quit.
